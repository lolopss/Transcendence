...
ChartJS.register(ArcElement, CategoryScale, LinearScale, BarElement, Title);
                        ...
                        {userDetails.matchHistory.map((match, index) => (
                            <li key={index} className="match-entry">
                                ...
                                <div className="match-details">
                                    <div className="match-players">{match.player1} vs {match.player2}</div>
                                    <div className="match-score"> ({match.score_player1} - {match.score_player2}) </div>
                                    <div className="match-winner">{translations.winner} : {match.winner}</div>
                                    <div className="match-duration">{translations.duration} : {formatTime(match.duration)}</div>
                                    <div className="match-histogram">
                                        <Bar
                                            data={{
                                                labels: [match.player1, match.player2],
                                                datasets: [
                                                    {
                                                        label: 'Points',
                                                        data: [match.score_player1, match.score_player2],
